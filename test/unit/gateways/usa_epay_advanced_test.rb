...
class UsaEpayAdvancedTest < Test::Unit::TestCase
  ...
  def test_successful_get_customer_history_method
    @gateway.expects(:ssl_post).returns(successful_get_customer_history_response)

    assert response = @gateway.get_customer_history(@options.merge!(:customer_number => 2733702))
    assert_instance_of Response, response
    assert_success response
    assert response.test?
    assert_nil response.authorization
    assert_instance_of Hash, response.message
    assert_equal 2, response.message["transactions"]["item"].length
    assert_equal 2, response.message["transactions_returned"].to_i
  end
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="urn:usaepay" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"><SOAP-ENV:Body><ns1:getCustomerPaymentMethodsResponse><getCustomerPaymentMethodsReturn SOAP-ENC:arrayType="ns1:PaymentMethod[2]" xsi:type="ns1:PaymentMethodArray"><item xsi:type="ns1:PaymentMethod"><MethodType xsi:type="xsd:string">cc</MethodType><MethodID xsi:type="xsd:integer">93</MethodID><MethodName xsi:type="xsd:string">My CC</MethodName><SecondarySort xsi:type="xsd:integer">5</SecondarySort><Created xsi:type="xsd:dateTime">2011-06-09T08:10:44+08:00</Created><Modified xsi:type="xsd:dateTime">2011-06-09T08:10:44+08:00</Modified><AvsStreet xsi:type="xsd:string">1234 My Street</AvsStreet><AvsZip xsi:type="xsd:string">K1C2N6</AvsZip><CardExpiration xsi:type="xsd:string">2012-12</CardExpiration><CardNumber xsi:type="xsd:string">XXXXXXXXXXXX2224</CardNumber><CardType xsi:type="xsd:string">V</CardType></item><item xsi:type="ns1:PaymentMethod"><MethodType xsi:type="xsd:string">cc</MethodType><MethodID xsi:type="xsd:integer">94</MethodID><MethodName xsi:type="xsd:string">Other CC</MethodName><SecondarySort xsi:type="xsd:integer">12</SecondarySort><Created xsi:type="xsd:dateTime">2011-06-09T08:10:44+08:00</Created><Modified xsi:type="xsd:dateTime">2011-06-09T08:10:44+08:00</Modified><AvsStreet xsi:type="xsd:string">1234 My Street</AvsStreet><AvsZip xsi:type="xsd:string">K1C2N6</AvsZip><CardExpiration xsi:type="xsd:string">2012-12</CardExpiration><CardNumber xsi:type="xsd:string">XXXXXXXXXXXX2224</CardNumber><CardType xsi:type="xsd:string">V</CardType></item></getCustomerPaymentMethodsReturn></ns1:getCustomerPaymentMethodsResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>
  ...
  def successful_get_customer_history_response
    <<-XML
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="urn:usaepay" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"><SOAP-ENV:Body><ns1:getCustomerHistoryResponse><getCustomerHistoryReturn xsi:type="ns1:TransactionSearchResult"><AuthOnlyAmount xsi:type="xsd:float">0</AuthOnlyAmount><AuthOnlyCount xsi:type="xsd:integer">0</AuthOnlyCount><CreditsAmount xsi:type="xsd:float">0</CreditsAmount><CreditsCount xsi:type="xsd:integer">0</CreditsCount><DeclinesAmount xsi:type="xsd:float">0</DeclinesAmount><DeclinesCount xsi:type="xsd:integer">0</DeclinesCount><ErrorsAmount xsi:type="xsd:float">7.99</ErrorsAmount><ErrorsCount xsi:type="xsd:integer">1</ErrorsCount><Limit xsi:type="xsd:integer">100</Limit><SalesAmount xsi:type="xsd:float">7.99</SalesAmount><SalesCount xsi:type="xsd:integer">1</SalesCount><StartIndex xsi:type="xsd:integer">0</StartIndex><Transactions SOAP-ENC:arrayType="ns1:TransactionObject[2]" xsi:type="ns1:TransactionObjectArray"><item xsi:type="ns1:TransactionObject"><AccountHolder xsi:type="xsd:string">Brandon Buck</AccountHolder><BillingAddress xsi:type="ns1:Address"><City xsi:type="xsd:string">Shreveport</City><Company xsi:type="xsd:string"></Company><Country xsi:type="xsd:string">US</Country><Email xsi:type="xsd:string"></Email><Fax xsi:type="xsd:string"></Fax><FirstName xsi:type="xsd:string">Brandon</FirstName><LastName xsi:type="xsd:string">Buck</LastName><Phone xsi:type="xsd:string"></Phone><State xsi:type="xsd:string">TX</State><Street xsi:type="xsd:string">111 That Place</Street><Street2 xsi:type="xsd:string"></Street2><Zip xsi:type="xsd:string">71104</Zip></BillingAddress><CheckData xsi:type="ns1:CheckData"><Account xsi:nil="true"/><Routing xsi:nil="true"/></CheckData><CheckTrace xsi:type="ns1:CheckTrace"/><ClientIP xsi:type="xsd:string"></ClientIP><CreditCardData xsi:type="ns1:CreditCardData"><AvsStreet xsi:type="xsd:string">111 That Place</AvsStreet><AvsZip xsi:type="xsd:string">71104</AvsZip><CardCode xsi:type="xsd:string">XXX</CardCode><CardExpiration xsi:type="xsd:string">XXXX</CardExpiration><CardNumber xsi:type="xsd:string">XXXXXXXXXXXX2224</CardNumber><CardPresent xsi:type="xsd:boolean">false</CardPresent><CardType xsi:type="xsd:string">V</CardType><InternalCardAuth xsi:type="xsd:boolean">false</InternalCardAuth><MagStripe xsi:type="xsd:string"></MagStripe><MagSupport xsi:type="xsd:string"></MagSupport><Pares xsi:type="xsd:string"></Pares><TermType xsi:type="xsd:string"></TermType></CreditCardData><CustomerID xsi:type="xsd:string">10</CustomerID><CustomFields SOAP-ENC:arrayType="ns1:FieldValue[0]" xsi:type="ns1:FieldValueArray"/><DateTime xsi:type="xsd:string">2013-12-03 10:30:54</DateTime><Details xsi:type="ns1:TransactionDetail"><Amount xsi:type="xsd:double">7.99</Amount><Clerk xsi:type="xsd:string"></Clerk><Currency xsi:type="xsd:string"></Currency><Description xsi:type="xsd:string">Sub fee</Description><Comments xsi:type="xsd:string"></Comments><Discount xsi:type="xsd:double">0</Discount><Invoice xsi:type="xsd:string"></Invoice><NonTax xsi:type="xsd:boolean">false</NonTax><OrderID xsi:type="xsd:string"></OrderID><PONum xsi:type="xsd:string"></PONum><Shipping xsi:type="xsd:double">0</Shipping><Subtotal xsi:type="xsd:double">0</Subtotal><Table xsi:type="xsd:string"></Table><Tax xsi:type="xsd:double">0</Tax><Terminal xsi:type="xsd:string"></Terminal><Tip xsi:type="xsd:double">0</Tip></Details><LineItems SOAP-ENC:arrayType="ns1:LineItem[0]" xsi:type="ns1:LineItemArray"/><Response xsi:type="ns1:TransactionResponse"><AcsUrl xsi:nil="true"/><AuthAmount xsi:type="xsd:double">7.99</AuthAmount><AuthCode xsi:nil="true"/><AvsResult xsi:type="xsd:string">No AVS response (Typically no AVS data sent or swiped transaction)</AvsResult><AvsResultCode xsi:type="xsd:string"></AvsResultCode><BatchNum xsi:type="xsd:integer">5</BatchNum><BatchRefNum xsi:type="xsd:integer">70066</BatchRefNum><CardCodeResult xsi:type="xsd:string">No CVV2/CVC data available for transaction.</CardCodeResult><CardCodeResultCode xsi:nil="true"/><CardLevelResult xsi:nil="true"/><CardLevelResultCode xsi:nil="true"/><ConversionRate xsi:type="xsd:double">0</ConversionRate><ConvertedAmount xsi:type="xsd:double">0</ConvertedAmount><ConvertedAmountCurrency xsi:type="xsd:string"></ConvertedAmountCurrency><CustNum xsi:type="xsd:integer">2733702</CustNum><Error xsi:type="xsd:string">Refund not permitted, original sale not settled</Error><ErrorCode xsi:type="xsd:integer">115</ErrorCode><isDuplicate xsi:type="xsd:boolean">false</isDuplicate><Payload xsi:nil="true"/><RefNum xsi:type="xsd:integer">58924830</RefNum><Result xsi:type="xsd:string">Error</Result><ResultCode xsi:type="xsd:string">E</ResultCode><Status xsi:type="xsd:string">Pending</Status><StatusCode xsi:type="xsd:string">P</StatusCode><VpasResultCode xsi:nil="true"/></Response><ServerIP xsi:type="xsd:string">74.93.149.214</ServerIP><ShippingAddress xsi:type="ns1:Address"><City xsi:type="xsd:string"></City><Company xsi:type="xsd:string"></Company><Country xsi:type="xsd:string"></Country><Email xsi:type="xsd:string"></Email><Fax xsi:type="xsd:string"></Fax><FirstName xsi:type="xsd:string"></FirstName><LastName xsi:type="xsd:string"></LastName><Phone xsi:type="xsd:string"></Phone><State xsi:type="xsd:string"></State><Street xsi:type="xsd:string"></Street><Street2 xsi:type="xsd:string"></Street2><Zip xsi:type="xsd:string"></Zip></ShippingAddress><Source xsi:type="xsd:string">streaming_site</Source><Status xsi:type="xsd:string">Error (Refund not permitted, original sale not settled)</Status><TransactionType xsi:type="xsd:string">Credit</TransactionType><User xsi:type="xsd:string"></User></item><item xsi:type="ns1:TransactionObject"><AccountHolder xsi:type="xsd:string">Brandon Buck</AccountHolder><BillingAddress xsi:type="ns1:Address"><City xsi:type="xsd:string">Shreveport</City><Company xsi:type="xsd:string"></Company><Country xsi:type="xsd:string">US</Country><Email xsi:type="xsd:string"></Email><Fax xsi:type="xsd:string"></Fax><FirstName xsi:type="xsd:string">Brandon</FirstName><LastName xsi:type="xsd:string">Buck</LastName><Phone xsi:type="xsd:string"></Phone><State xsi:type="xsd:string">TX</State><Street xsi:type="xsd:string">111 That Place</Street><Street2 xsi:type="xsd:string"></Street2><Zip xsi:type="xsd:string">71104</Zip></BillingAddress><CheckData xsi:type="ns1:CheckData"><Account xsi:nil="true"/><Routing xsi:nil="true"/></CheckData><CheckTrace xsi:type="ns1:CheckTrace"/><ClientIP xsi:type="xsd:string"></ClientIP><CreditCardData xsi:type="ns1:CreditCardData"><AvsStreet xsi:type="xsd:string">111 That Place</AvsStreet><AvsZip xsi:type="xsd:string">71104</AvsZip><CardCode xsi:type="xsd:string">XXX</CardCode><CardExpiration xsi:type="xsd:string">XXXX</CardExpiration><CardNumber xsi:type="xsd:string">XXXXXXXXXXXX2224</CardNumber><CardPresent xsi:type="xsd:boolean">false</CardPresent><CardType xsi:type="xsd:string">V</CardType><InternalCardAuth xsi:type="xsd:boolean">false</InternalCardAuth><MagStripe xsi:type="xsd:string"></MagStripe><MagSupport xsi:type="xsd:string"></MagSupport><Pares xsi:type="xsd:string"></Pares><TermType xsi:type="xsd:string"></TermType></CreditCardData><CustomerID xsi:type="xsd:string">10</CustomerID><CustomFields SOAP-ENC:arrayType="ns1:FieldValue[0]" xsi:type="ns1:FieldValueArray"/><DateTime xsi:type="xsd:string">2013-12-03 10:31:35</DateTime><Details xsi:type="ns1:TransactionDetail"><Amount xsi:type="xsd:double">7.99</Amount><Clerk xsi:type="xsd:string"></Clerk><Currency xsi:type="xsd:string"></Currency><Description xsi:type="xsd:string">Sub fee</Description><Comments xsi:type="xsd:string"></Comments><Discount xsi:type="xsd:double">0</Discount><Invoice xsi:type="xsd:string"></Invoice><NonTax xsi:type="xsd:boolean">false</NonTax><OrderID xsi:type="xsd:string"></OrderID><PONum xsi:type="xsd:string"></PONum><Shipping xsi:type="xsd:double">0</Shipping><Subtotal xsi:type="xsd:double">0</Subtotal><Table xsi:type="xsd:string"></Table><Tax xsi:type="xsd:double">0</Tax><Terminal xsi:type="xsd:string"></Terminal><Tip xsi:type="xsd:double">0</Tip></Details><LineItems SOAP-ENC:arrayType="ns1:LineItem[0]" xsi:type="ns1:LineItemArray"/><Response xsi:type="ns1:TransactionResponse"><AcsUrl xsi:nil="true"/><AuthAmount xsi:type="xsd:double">7.99</AuthAmount><AuthCode xsi:type="xsd:string">198175</AuthCode><AvsResult xsi:type="xsd:string">Address: Match &amp; 5 Digit Zip: Match</AvsResult><AvsResultCode xsi:type="xsd:string">YYY</AvsResultCode><BatchNum xsi:type="xsd:integer">5</BatchNum><BatchRefNum xsi:type="xsd:integer">70066</BatchRefNum><CardCodeResult xsi:type="xsd:string">Match</CardCodeResult><CardCodeResultCode xsi:type="xsd:string">M</CardCodeResultCode><CardLevelResult xsi:nil="true"/><CardLevelResultCode xsi:nil="true"/><ConversionRate xsi:type="xsd:double">0</ConversionRate><ConvertedAmount xsi:type="xsd:double">0</ConvertedAmount><ConvertedAmountCurrency xsi:type="xsd:string"></ConvertedAmountCurrency><CustNum xsi:type="xsd:integer">2733702</CustNum><Error xsi:type="xsd:string">Approved</Error><ErrorCode xsi:type="xsd:integer">0</ErrorCode><isDuplicate xsi:type="xsd:boolean">false</isDuplicate><Payload xsi:nil="true"/><RefNum xsi:type="xsd:integer">58924832</RefNum><Result xsi:type="xsd:string">Approved</Result><ResultCode xsi:type="xsd:string">A</ResultCode><Status xsi:type="xsd:string">Pending</Status><StatusCode xsi:type="xsd:string">P</StatusCode><VpasResultCode xsi:nil="true"/></Response><ServerIP xsi:type="xsd:string">74.93.149.214</ServerIP><ShippingAddress xsi:type="ns1:Address"><City xsi:type="xsd:string"></City><Company xsi:type="xsd:string"></Company><Country xsi:type="xsd:string"></Country><Email xsi:type="xsd:string"></Email><Fax xsi:type="xsd:string"></Fax><FirstName xsi:type="xsd:string"></FirstName><LastName xsi:type="xsd:string"></LastName><Phone xsi:type="xsd:string"></Phone><State xsi:type="xsd:string"></State><Street xsi:type="xsd:string"></Street><Street2 xsi:type="xsd:string"></Street2><Zip xsi:type="xsd:string"></Zip></ShippingAddress><Source xsi:type="xsd:string">streaming_site</Source><Status xsi:type="xsd:string">Authorized (Pending Settlement)</Status><TransactionType xsi:type="xsd:string">Sale</TransactionType><User xsi:type="xsd:string"></User></item></Transactions><TransactionsMatched xsi:type="xsd:integer">2</TransactionsMatched><TransactionsReturned xsi:type="xsd:integer">2</TransactionsReturned><VoidsAmount xsi:type="xsd:float">0</VoidsAmount><VoidsCount xsi:type="xsd:integer">0</VoidsCount></getCustomerHistoryReturn></ns1:getCustomerHistoryResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>
    XML
  end
